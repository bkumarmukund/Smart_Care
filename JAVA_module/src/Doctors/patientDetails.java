...
public final class patientDetails extends javax.swing.JFrame {
    ...
    public patientDetails(String pid) {
        ...
        patientID = pid;
        Object columns[] = {"patientID", "Name", "disease", "treated on"};
    ...
    public void loadData() {
        ...
        String sql = "select patientID, FN, LN, disease, cast(date as date) as visitedON FROM medicalHISTORY INNER JOIN patient on medicalHISTORY.patHID = patient.patientID WHERE patientID = '" + patientID + "'";
        try {
            ...
            while (rs.next()) {
                ...
                columnData[1] = rs.getString("FN")+"  "+rs.getString("LN");
                columnData[2] = rs.getString("disease");
                columnData[3] = rs.getString("visitedON");
    ...
    private void jLabel21MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel21MouseClicked
        Appointment appointment = new Appointment(patientID);
