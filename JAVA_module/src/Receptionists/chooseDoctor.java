...
public class chooseDoctor extends javax.swing.JFrame {
    ...
    public chooseDoctor() {
        ...
        Object columns[] = {"doctorID", "departmentNAME", "FN", "MN", "LN", "age", "gender", "room", "depID"};
    ...
    private void initComponents() {
        ...
        dSearchbox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Department", "Gynaecology", "Paediatrics", "Ophthalmology", "ENT", "Dentistry", "General", "Nurtition", "Orthopaedics", "Neurology", "Cardiology", "Psychiatry", "Infectious disease", "Burn Unit", "Trauma", " " }));
    ...
    private void dASearchbtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dASearchbtnMouseClicked
        ...
        String sql = "select doctorID, departmentNAME, FN, MN, LN, age, gender, room, depID FROM doctor INNER JOIN department on doctor.depID = department.departmentID WHERE department.departmentNAME = '" + searchKey + "'";
        try {
            ...
            while (rs.next()) {
                ...
                columnData[1] = rs.getString("departmentNAME");
                columnData[2] = rs.getString("FN");
                columnData[3] = rs.getString("MN");
                columnData[4] = rs.getString("LN");
                columnData[5] = rs.getInt("age");
                columnData[6] = rs.getString("gender");
                columnData[7] = rs.getInt("room");
                columnData[8] = rs.getString("depID");
    ...
    private void dASearchbtn1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dASearchbtn1MouseClicked
        ...
        String docNAME = (apTable.getValueAt(row, 2).toString())+(apTable.getValueAt(row, 4).toString());
        int room = Integer.parseInt(apTable.getValueAt(row, 7).toString());
        choosePatient cPatient = new choosePatient();
        cPatient.dName = docID;
        cPatient.droom = room;
        cPatient.dRealName = docNAME;
