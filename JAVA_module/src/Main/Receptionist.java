...
public class Receptionist extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mLabel.setText("Smart_Care_R-Login");
        ...
        dUser.setBounds(250, 170, 129, 29);
        ...
        rPassField.setBounds(390, 300, 279, 40);
    ...
    private void rLoginBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rLoginBtnActionPerformed
        ...
        try {
            //System.out.println("inside try of Receptionist!");
            String sql = "select usernameR, passwordR, FN, LN from receptionist where usernameR='" + user + "'";
            prp = connection.prepareStatement(sql);
            result = prp.executeQuery();
            result.first();
            if (pass.equals(result.getString("passwordR"))) {
                ReceptionistActivity rActivity = new ReceptionistActivity();
                rActivity.setVisible(true);
                username = user;
                String receptionist_name;
                receptionist_name = result.getString("FN")+"  "+result.getString("LN");
                ReceptionistActivity.username = username;
                ReceptionistActivity.realname = receptionist_name;
                JOptionPane.showMessageDialog(null, "Login Succesful", "Welcome " + receptionist_name, JOptionPane.INFORMATION_MESSAGE);
                dispose();
                connection.close();
            } else {
