		...
		<table class="table table-hover">
		   ...
		   <th scope="col">Patient Name</th>
		    ...
		    $con=mysqli_connect("13.234.59.129","balmukund","passbird","smart_care");
                    global $con;
                    $query = "select patient.patientID,doctor.doctorID, CONCAT(patient.FN , ' ' , patient.MN , ' ' , patient.LN) AS PatientName, CONCAT(doctor.FN , ' ' , doctor.MN , ' ' , doctor.LN) AS DoctorName, department.departmentNAME, appointment.disease, date(appointment.appointmentDATE) AS AppointmentDate FROM appointment
INNER JOIN patient
ON patient.patientID = appointment.patientID
INNER JOIN doctor
ON doctor.doctorID = appointment.doctorID
INNER JOIN department
on department.departmentID = doctor.depID";
